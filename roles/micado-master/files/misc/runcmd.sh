...
git clone https://github.com/micado-scale/component_submitter.git /var/lib/toscasubmitter/src
cd /var/lib/toscasubmitter/src
git checkout adaptor_integration
