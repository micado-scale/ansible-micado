...
- stressng
  ...
  - Step2: run ```5-tosca-submit-stressng.sh``` to deploy the stressng service using TOSCA *optionally add as an argument a user-defined app_id (ie. ./5-tosca-submit-stressng.sh MyApp )
